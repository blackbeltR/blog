...
This work is the result of a question that came up on the WhatsApp group of our site [**blackbeltR**](https://www.blackbeltR.com.br){target="_blank"}. A user came up with this problem and I decided to help him. It was a cool challenge, so why not?
...
headline_all <- google %>% html_nodes("article") %>% html_text("span") %>%
  str_split("(?<=[a-z0-9áéóí!?])(?=[A-Z])") # also considering portuguese special characters
