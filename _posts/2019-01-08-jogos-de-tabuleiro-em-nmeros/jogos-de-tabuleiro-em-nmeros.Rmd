...
description: |
  Estatísticas de jogos de tabuleiro modernos, publicado originalmente em https://pinduzera.github.io/
author:
  - name: Eduardo Ochetski Hellas
    url: https://pinduzera.github.io/
date: 01-08-2019
output:
  radix::radix_article:
...
load(file = "E:/Dropbox/Program/pindata/dados e rascunhos/bgg/bgg_info_mt2.RData")
...
```{r lancamentos, fig.width=6, fig.height=5}
...
```{r mecas2, fig.width=10, fig.height=7}
 tam <- c(10, 20, 50, 200)
for(i in 1:4){ 
