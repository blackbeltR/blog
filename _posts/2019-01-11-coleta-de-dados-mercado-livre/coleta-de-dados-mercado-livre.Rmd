...
[Mercado Livre (ML)](http://mercadolivre.com.br/){target="blank_"} é um local "onde se compra e vende de tudo". Outro dia meu notebook deu problema da abertura da tela e não tinha mais como ficar abrindo e fechando então o transformei em uma estação de mídia da minha casa (i3 com 8GB de ram), usando o [Linux Mint MATE 19](https://linuxmint.com/){target="blank_"} instalei o [Stremio](https://www.stremio.com/br/){target="blank_"} (Fica a dica).
